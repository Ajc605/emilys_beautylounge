...
export const metadata: Metadata = {
  ...
  description: 'Book an appoinmnet for Emily\'s Beautiy Lounge or browes our product catalog',
}
...
})
{
  const navItems = [
    ...
    { href: '/booking', class: 'bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 rounded-full', name: 'Booking' }
  ];
